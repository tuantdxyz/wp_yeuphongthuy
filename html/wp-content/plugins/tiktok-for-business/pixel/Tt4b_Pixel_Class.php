...
class Tt4b_Pixel_Class {
	...
	public static function inject_add_to_cart_event( $cart_item_key, $product_id, $quantity, $variation_id ) {
		...
		$hashed_email = $pixel_obj->get_advanced_matching_hashed_email( $fields['access_token'], $fields['advertiser_id'], $fields['pixel_code'], $email );
	 ...
	 * @return false|string
	 */
	public function get_advanced_matching_hashed_email( $access_token, $advertiser_id, $pixel_code, $email ) {
		...
		$pixel_obj         = new Tt4b_Pixel_Class();
		$pixel_rsp         = $pixel_obj->get_pixels( $access_token, $advertiser_id, $pixel_code );
